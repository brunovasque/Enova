...
function enovaV1Scenarios(modeOverride = null) {
  const common = [
    ...
    { id: "civil_confirmar_casamento_civil", grupo: "civil", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_composicao_v1", start_stage: "confirmar_casamento", input: "sim, casado no papel", expected: { type: "single", equals: "regime_trabalho" } },
    { id: "civil_confirmar_casamento_uniao", grupo: "civil", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_composicao_v1", start_stage: "confirmar_casamento", input: "não, é união estável", expected: { type: "single", equals: "financiamento_conjunto" } },
    ...
    { id: "civil_financiamento_conjunto_fallback", grupo: "civil", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_composicao_v1", start_stage: "financiamento_conjunto", input: "não sei", expected: { type: "single", equals: "financiamento_conjunto" }, assert_stayed: true },
    ...
    { id: "multi_regime_pergunta_nao", grupo: "multi", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_renda_v1", start_stage: "inicio_multi_regime_pergunta", input: "não", expected: { type: "single", equals: "inicio_multi_renda_pergunta" } },
    ...
    { id: "multi_renda_pergunta_nao", grupo: "multi", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_renda_v1", start_stage: "inicio_multi_renda_pergunta", input: "não", expected: { type: "single", equals: "renda" } },
    ...
    { id: "familiar_ctps_36_fallback", grupo: "familiar_p3", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_familiar_v1", start_stage: "ctps_36_parceiro", input: "talvez", expected: { type: "single", equals: "ctps_36_parceiro" }, assert_stayed: true },
    ...
    { id: "p3_ctps_36_fallback", grupo: "familiar_p3", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_familiar_p3_v1", start_stage: "ctps_36_parceiro_p3", input: "talvez", expected: { type: "single", equals: "ctps_36_parceiro_p3" }, assert_stayed: true },
    ...
    { id: "p3_restricao_fallback", grupo: "familiar_p3", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_familiar_p3_v1", start_stage: "restricao_parceiro_p3", input: "não sei", expected: { type: "single", equals: "restricao_parceiro_p3" }, assert_stayed: true },
    ...
    { id: "p3_regularizacao_fallback", grupo: "familiar_p3", mode: "simulate-from-state", allowed_modes: ["simulate-from-state","simulate-funnel"], fixture: "fx_familiar_p3_v1", start_stage: "regularizacao_restricao_p3", input: "talvez", expected: { type: "single", equals: "regularizacao_restricao_p3" }, assert_stayed: true },
